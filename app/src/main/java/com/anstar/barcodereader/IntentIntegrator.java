...
package com.anstar.barcodereader;
...
public class IntentIntegrator {
	...
	private static final String BS_PACKAGE = "com.anstar.barcodereader.zxing";
	...
	public static final Collection<String> TARGET_ALL_KNOWN = list(BS_PACKAGE);
