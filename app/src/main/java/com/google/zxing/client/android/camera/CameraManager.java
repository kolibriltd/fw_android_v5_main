...
import com.anstar.barcodereader.zxing.PlanarYUVLuminanceSource;
...
public final class CameraManager {
	...
	public void OnFlash(Context c) {
		try {
			
			if (c.getPackageManager().hasSystemFeature(
					c.getPackageManager().FEATURE_CAMERA_FLASH)) {
	...
	public void OffFlash(Context c) {
		if (c.getPackageManager().hasSystemFeature(
				c.getPackageManager().FEATURE_CAMERA_FLASH)) {
			Parameters params = camera.getParameters();
